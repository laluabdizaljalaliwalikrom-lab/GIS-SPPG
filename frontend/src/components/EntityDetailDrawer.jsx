                          ...
                          <div className="flex items-center justify-between mb-8">
                            <h4 className="text-[10px] font-black text-blue-600 uppercase tracking-[0.2em] flex items-center gap-2">
                             ...
                             <div className="px-3 py-1 bg-blue-600 text-white rounded-full text-[10px] font-black uppercase tracking-widest">
                               SCORE: {Math.round(
                                 ((entity.infrastruktur_score || 0) +
                                  (entity.peralatan_score || 0) +
                                  (entity.k3_lingkungan_score || 0) +
                                  (entity.paket_mbg_score || 0) +
                                  (entity.distribusi_score || 0) +
                                  (entity.dokumentasi_score || 0) +
                                  (entity.penerima_manfaat_score || 0) +
                                  (entity.tenaga_kerja_score || 0) +
                                  (entity.sertifikat_iso_score || 0) +
                                  (entity.administrasi_score || 0)) / 10
                               )}%
                             </div>
                           </div>
                           ...
                           <div className="space-y-6 max-h-[350px] overflow-y-auto pr-2">
                             <ScoreBar 
                               label="Bangunan & Infrastruktur" 
                               score={entity.infrastruktur_score || 0} 
                               color="bg-emerald-500"
                             />
                             <ScoreBar 
                               label="Peralatan" 
                               score={entity.peralatan_score || 0} 
                               color="bg-indigo-500"
                             />
                             <ScoreBar 
                               label="K3 & Kesehatan Lingkungan" 
                               score={entity.k3_lingkungan_score || 0} 
                               color="bg-rose-500"
                             />
                             <ScoreBar 
                               label="Paket Program MBG" 
                               score={entity.paket_mbg_score || 0} 
                               color="bg-pink-500"
                             />
                             <ScoreBar 
                               label="Penyaluran & Distribusi" 
                               score={entity.distribusi_score || 0} 
                               color="bg-amber-500"
                             />
                             <ScoreBar 
                               label="Dokumentasi & Monitoring" 
                               score={entity.dokumentasi_score || 0} 
                               color="bg-cyan-500"
                             />
                             <ScoreBar 
                               label="Penerima Manfaat" 
                               score={entity.penerima_manfaat_score || 0} 
                               color="bg-violet-500"
                             />
                             <ScoreBar 
                               label="Tenaga Kerja" 
                               score={entity.tenaga_kerja_score || 0} 
                               color="bg-blue-500"
                             />
                             <ScoreBar 
                               label="Sertifikasi & ISO" 
                               score={entity.sertifikat_iso_score || 0} 
                               color="bg-orange-500"
                             />
                             <ScoreBar 
                               label="Administrasi & Keuangan" 
                               score={entity.administrasi_score || 0} 
                               color="bg-slate-500"
                             />
                           </div>
